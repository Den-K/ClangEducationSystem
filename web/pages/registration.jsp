    ...
    <div class="row">
        <div class="center-block" style="width: 650px">
            <div class="well" style="margin-top: 60px">
                <form class="form-horizontal" action="${pageContext.request.contextPath}/registration/"
                      method="post">
                    <fieldset>
                        <div class="form-group">
                            <label for="login" class="col-lg-3 control-label">Логін</label>
                            <div class="col-lg-8">
                                <input required="required" name="login" class="form-control" id="login" placeholder="Логін" type="text">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input required="required" name="firstName" class="form-control" id="firstName" placeholder="Ім'я" type="text">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="lastName" class="col-lg-3 control-label">Прізвище</label>
                            <div class="col-lg-8">
                                <input required="required" name="lastName" class="form-control" id="lastName" placeholder="Прізвище" type="text">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="password" class="col-lg-3 control-label">Пароль</label>
                            <div class="col-lg-8">
                                <input required="required" name="password" class="form-control" id="password" placeholder="Пароль" type="password">
                            </div>
                        </div>
                        <div class="form-group">
